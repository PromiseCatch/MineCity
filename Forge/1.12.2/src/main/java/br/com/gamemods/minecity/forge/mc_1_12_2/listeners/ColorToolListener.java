...
public class ColorToolListener extends br.com.gamemods.minecity.forge.base.listeners.ToolListener {
    public ColorToolListener(MineCityForge forge) {
        super(forge);
    }
    ...
    private void onPlayerInteract(PlayerInteractEvent event, boolean left) {
        ...
        if (onPlayerInteract(
                ...
                world, pos.getX(), pos.getY(), pos.getZ(), left
        )) {
