...
public class ColorIndustrialCraftListener extends IndustrialCraftProtections {
    public ColorIndustrialCraftListener(MineCityForge mod)
    {
        super(mod);
    }
    ...
    public void onExplosionIC2(ExplosionEvent event) {
        if (onExplosionIC2(
                ...
                new PrecisePoint(event.pos.x, event.pos.y, event.pos.z), event.power,
